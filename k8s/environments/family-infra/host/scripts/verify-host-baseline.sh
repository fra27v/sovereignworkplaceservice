...
hostname_value="family-infra-01"
ssh_port="50022"
...
Read-only verification of the family-infra host OS baseline.
...
check_operating_system() {
  ...
  case "${arch_value}" in
    x86_64|amd64)
      ...
      ;;
    *)
      warn "architecture is ${arch_value}; expected x86_64/amd64 for family-infra-01."
      ;;
  esac
}
